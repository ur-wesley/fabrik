0a. Study ai/docs/PRD.md to understand the requirements context.
0b. Study the task list under `ai/.tasks/` and select the lowest-numbered open task file.
...
4. Once all validations pass:
   * Move the selected task file from `ai/.tasks/` to `ai/.tasks/completed/`.
